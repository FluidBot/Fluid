...
import com.fluidbot.bot.loader.arch.ArchiveClassLoader;
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (evt.getPropertyName().equals("version_check")) {
			...
			if (value == RESULT_UP_TO_DATE) {
				...
				BotWindow.error("Out of date!", "Fluid has been updated, re-download the new version at http://www.fluidbot.com/");
				System.out.println("OUT_OF_DATE");
				System.exit(0);
			} else if (value == RESULT_FALLBACK) {
				setVisible(false);
				BotWindow.warn("Friendly Reminder", "To stay updated, always use the updater to launch Fluid.");
				Application.window = new BotWindow();
