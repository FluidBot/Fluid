package com.fluidbot.bot.loader.arch;
...
import com.fluidbot.bot.SDN;
import com.fluidbot.bot.util.InstructionSearcher;
			...
			for (MethodNode mn : (List<MethodNode>) node.methods) {
				...
				if (searcher.match()) {
					...
					if (search.match()) {
						...
						mn.instructions.insert(var2, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/fluidbot/bot/script/callback/ModelCallback", "callback", "(Lcom/fluidbot/insertion/IRenderable;Lcom/fluidbot/insertion/IModel;)V"));
